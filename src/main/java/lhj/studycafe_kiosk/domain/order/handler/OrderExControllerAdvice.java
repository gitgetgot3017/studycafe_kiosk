package lhj.studycafe_kiosk.domain.order.handler;

import lhj.studycafe_kiosk.domain.member.dto.FindMemberFailResponse;
import lhj.studycafe_kiosk.domain.member.exception.NotExistMemberException;
import lhj.studycafe_kiosk.domain.order.controller.OrderController;
import lhj.studycafe_kiosk.domain.order.dto.GuestsOrderFailResponse;
import lhj.studycafe_kiosk.domain.order.dto.OrderCancelFailResponse;
import lhj.studycafe_kiosk.domain.order.dto.OrderFailResponse;
import lhj.studycafe_kiosk.domain.order.dto.ShowOrderFailResponse;
import lhj.studycafe_kiosk.domain.order.exception.*;
