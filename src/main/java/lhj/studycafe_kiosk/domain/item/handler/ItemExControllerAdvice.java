package lhj.studycafe_kiosk.domain.item.handler;

import lhj.studycafe_kiosk.domain.item.controller.ItemController;
import lhj.studycafe_kiosk.domain.item.dto.FindItemFailResponse;
import lhj.studycafe_kiosk.domain.item.dto.ItemRegFailResponse;
import lhj.studycafe_kiosk.domain.item.exception.DuplicateItemNameException;
