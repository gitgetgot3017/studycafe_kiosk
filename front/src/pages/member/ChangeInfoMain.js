        ...
        <div className="bg-dark d-flex align-items-center justify-content-center" style={{height: "100vh"}}>
            <div className="profile-container bg-white p-5 rounded shadow-lg text-center">
                ...
                <div className="d-grid gap-3">
                    <button className="btn btn-outline-primary">내 정보 변경</button>
                    <button className="btn btn-outline-primary">비밀번호 변경</button>
                    <button className="btn btn-outline-primary">휴대폰번호 변경</button>
                </div>
            </div>
        </div>
    );
